# Calculador de áreas. Calcular área de formas geométricas: quadrado, retangulo, triangulo, circulo
...
if opcao == '1':
  lado: float = float(input('Digite o lado do quadrado: '))
  print('A área do quadrado é: ',lado ** 2)
elif opcao == '2':
  ladoA: float = float(input('Digite o ladoA: '))
  ladoB: float = float(input('Digite o ladoB: '))
